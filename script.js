document.addEventListener('DOMContentLoaded', () => {
    const eventList = [
        { date: '2024-07-01', title: 'Hunde-Treffen am Abend', description: 'Treffen Sie andere Hundebesitzer und genießen Sie einen Abend mit Ihren Hunden.' },
        { date: '2024-07-15', title: 'Grillabend für Mensch und Hund', description: 'Grillen Sie mit Ihren Hunden und anderen Gästen.' },
        { date: '2024-07-29', title: 'Veggie Tag', description: 'Ein spezieller Tag für Vegetarier und ihre Hunde.' }
    ];
    ...
    // Set today's date to 02.07.2024
    ...
    function generateCalendar(month, year) {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            if (eventForDay) {
                ...
                eventDetailsDiv.innerHTML = `<strong>${eventForDay.title}</strong><p>${eventForDay.description}</p>`;
